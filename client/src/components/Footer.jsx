        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="text-gray-300 text-sm leading-relaxed max-w-md">
              ...
              expo of 2025 featuring cutting-edge technology, inspiring
              speakers, and unforgettable experiences.
            </p>
          ...
          <div>
            ...
            <div className="space-y-2">
              <div className="flex items-center space-x-2 text-gray-300 text-sm">
                <HiEnvelope className="text-cyan-400 text-lg flex-shrink-0" />
                <span>events@collegeexpo.edu</span>
              </div>
              <div className="flex items-center space-x-2 text-gray-300 text-sm">
                <HiPhone className="text-purple-400 text-lg flex-shrink-0" />
                <span>+1 (555) 123-4567</span>
              </div>
              <div className="flex items-start space-x-2 text-gray-300 text-sm">
                <HiMapPin className="text-pink-400 text-lg flex-shrink-0 mt-0.5" />
                <span>
                  Gayatri Vidya Parishad College of Engineering, Madhurawada,
                  Visakhapatnam
                </span>
              </div>
            </div>
