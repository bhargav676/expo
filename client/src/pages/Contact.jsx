                ...
                <div className="flex gap-4">
                  {[
                    ...
                    <a
                      key={index}
                      href="#"
                      className={`w-12 h-12 bg-${social.color}-500/10 hover:bg-${social.color}-500/20 rounded-lg flex items-center justify-center text-${social.color}-500 transition-all duration-300 hover:shadow-lg hover:shadow-${social.color}-500/50`}
                    >
                      <svg
                        className="w-5 h-5"
                        fill="currentColor"
